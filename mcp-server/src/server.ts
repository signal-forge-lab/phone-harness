...
export function createPhoneMcpServer(runtime: RuntimeBridge): McpServer {
  ...
  server.registerTool(
    "phone_observe",
    {
      description: "Observe the current iPhone screen. Uses accessibility first and OCR fallback. Returns temporary element_ref values for precise follow-up actions and hides document/editable text bodies by default.",
      inputSchema: {
